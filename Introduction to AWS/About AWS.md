...
- 2004: AWS started out as a department within Amazon Inc. Web services are not available publicly
- 2006: AWS officially started its operation as a public cloud service provider
	  They released Amazon S3 (Simple Storage Service), Amazon SQS (Simple Queue Service)
- 2007: AWS launched Elastic Compute Cloud (EC2)
- Today: Offers hundreds of fully-features service that are available globally
For a detailed chronological breakdown, refer to the [AWS Service Timeline](https://en.wikipedia.org/wiki/Timeline_of_Amazon_Web_Services) 
